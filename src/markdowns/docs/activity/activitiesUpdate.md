::::docs-panel{id=left target=#api-Activities-updateActivityById}

### 활동 업데이트 (updateActivityById)

인증된 선수가 소유한 특정 활동을 업데이트합니다. 활동: 쓰기가 필요합니다. 또한 활동이 필요합니다.
나만 작업 업데이트하기 위해 read_all

:docs-http-method{method=put url=/activities/id}
...
:docs-table-row{
name="&#60;Parameter Name &#62;"
requiredText="UpdatableActivity, in body"
description="<a href='/docs/reference/#api-models-UpdatableActivity'>UpdatableActivity</a>의 인스턴스 입니다."
}
:::
...
:docs-table-row{
name="HTTP code 200"
description="활동의 세부 표현입니다. <a href='/docs/reference/#api-models-DetailedActivity'>DetailedActivity</a>의 인스턴스입니다."
}
:docs-table-row{
