::::docs-panel{id=left target=#api-Gears-getGearById}

### 장비 가져오기 (getGearById)

식별자를 사용하여 장비를 반환합니다.

:docs-http-method{method=get url=/gear/&lbrace;id&rbrace;}
...
:docs-table-row{
name="id"
requiredText="required String, in path"
description="장비의 식별자입니다."
}
:::
...
:docs-table-row{
name="HTTP code 200"
description="기어의 표현입니다. <a href='/docs/reference/#api-models-DetailedGear'>DetailedGear</a>의 인스턴스입니다."
}
:docs-table-row{
